...
document.addEventListener(
    ...
    () => {
        ...
        if (!footer) {
            ...
            footer.innerHTML = `<div class="footer-inner"><a href="index.html" class="footer-brand"><img src="images/logo.svg" alt=""><span>SeyirAtlası</span></a><p class="footer-tagline">Sinema evrenindeki rotan.</p><p class="footer-copy">© 2026 SeyirAtlası</p></div>`;
